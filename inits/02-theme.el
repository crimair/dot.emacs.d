...
(custom-theme-set-faces
 ...
 '(font-lock-builtin-face ((t (:foreground "#667477"))))
 '(font-lock-comment-face ((t (:foreground "#6694B7" :slant italic))))
 '(font-lock-comment-delimiter-face ((t (:foreground "#6694B7" :slant italic))))
 ...
 '(isearch ((t (:foreground "#FFFFFF" :background "#497749"))))
 '(isearch-fail ((t (:foreground "#FFFFFF" :background "#333333"))))
 '(lazy-highlight ((t (:foreground "#FFFFFF" :background "#483d8b"))))
